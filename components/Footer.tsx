...
export const Footer = () => {
  return (
    <footer className="bg-gray-900 md:h-[40vh] h-auto w-full">
      <hr className="bg-gray-500 w-[75vw] mx-auto" />
      ...
      <hr className="bg-gray-500 w-[75vw] mx-auto md:mt-8 mt-4" />
      <div className="flex lg:flex-row flex-col items-center lg:justify-between md:px-48 px-2 py-4 gap-2 md:py-6 md:text-lg text-sm text-white opacity-90">
        ...
        <div className="flex gap-3 justify-center items-center">
          <Link key={2} href={"/contact"} target="_blank">
            <img
          ...
          <Link key={1} href={"https://linkedin.com"} target="_blank">
            <img
